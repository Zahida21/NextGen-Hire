...
function PdevopsEngineer() {
    ...
    return (
        <div className="devops-engineer-container">
            <button className="filter-button" onClick={filterData}>See Interviewed DevOps Engineers</button>
...
export default PdevopsEngineer;
